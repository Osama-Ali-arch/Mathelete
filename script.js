...
$(document).ready(function() {
    $(".grades-list .item").slice(0, 6).show(),
    $("#loadMore").on("click", function(e) {
        e.preventDefault(),
        $(".grades-list .item:hidden").slice(0, 3).slideDown(),
        0 == $(".grades-list .item:hidden").length && $("#loadMore").text("").addClass("noContent")
    }),
